...
typedef struct thread_control_block {
	...
	int priority; /**< @brief Variable to set the priority of the threads */
...
#define PRIORITY_QUEUES (12) /* Number of priority queues for MLFQ implementation (optimizable)*/

#define BOOST_PRIORITY 3000 /* Number of times yield is called before starvation boost occurs, N (optimizable)*/
